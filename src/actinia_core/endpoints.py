...
def create_endpoints(global_config):

    if "location_management" in global_config.ROLES:
        from actinia_core.resources.location_management import ListLocationsResource, LocationManagementResourceUser,\
            LocationManagementResourceAdmin
    ...
    if "mapset_management" in global_config.ROLES:
    ...
    if "raster_management" in global_config.ROLES:
    ...
    if "strds_management" in global_config.ROLES:
    ...
    if "async_processing" in global_config.ROLES:
        ...
        from actinia_core.resources.raster_export import AsyncEphemeralRasterLayerExportResource, \
            AsyncEphemeralRasterLayerRegionExportResource
    ...
    if "user_management" in global_config.ROLES:
    ...
    if "resource_management" in global_config.ROLES:
    ...
    if "download_cache_management" in global_config.ROLES:
    ...
    if "resource_storage_management" in global_config.ROLES:
