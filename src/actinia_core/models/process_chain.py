...
#
# SPDX-FileCopyrightText: (c) 2016-2024 Sören Gebbert and mundialis GmbH & Co. KG
#
    ...
    properties["export"] = {
        ...
        "properties": {
            "format": {
                ...
                "as downloadable link as well. Also PDF files as GRASS GIS "
            ...
            "type": {
                ...
                "option only text files and PDF are supported for export. "
