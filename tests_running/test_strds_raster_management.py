...
class STRDSTestCase(ActiniaResourceTestCaseBase):
    ...
    def test_strds_create_register_unregister_1(self):
        ...
        min_min = json_load(rv.data)["process_results"]["min_min"]
        max_max = json_load(rv.data)["process_results"]["max_max"]
        num_maps = json_load(rv.data)["process_results"]["number_of_maps"]
